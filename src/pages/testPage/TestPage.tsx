      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-blue-100 to-white p-4">
        <div className="rounded-2xl bg-white p-8 text-center shadow-xl">
          ...
          <button
            ...
            className="mb-4 rounded-xl border-b-6 border-blue-800 bg-blue-500 px-8 py-4 font-semibold text-white transition-all duration-200 active:mt-1 active:translate-y-1 active:border-b-2"
          >
            ¡Jugar otra vez!
          </button>
          <button
